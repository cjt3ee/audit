...
public class UserAuditFormMessage {
    ...
    public static class FormData {
        ...
        public FormData(Integer riskScore, String investorType, Double investmentAmount, 
                       Integer annualIncome, Integer maxLoss, Map<String, Object> questionnaireAnswers,
                       Integer customerAge, String occupation) {
    ...
    public UserAuditFormMessage(Long auditLogId, Long customerId, FormData formData, LocalDateTime submitTime) {
